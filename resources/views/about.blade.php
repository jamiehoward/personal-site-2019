...
<div class="lg:flex">
	...
	<div class="text-center lg:text-left lg:w-2/3 lg:px-6">
		...
		<a class="bg-gray-200 text-gray-600  hover:bg-gray-600 hover:text-white py-4 px-10" href="https://twitter.com/messages/compose?recipient_id=14348689&text=Hey+there!" target="_blank">
