...
<div>
	<div class="mb-4">
		...
		<p>
			A simple tracker for anything that can be quantified <a href="//routine.jamiehoward.co" target="_blank">See more →</a>
		</p>
	</div>
	...
	<div class="mb-4">
		...
		<p>A project that I built to give as a gift to friends and family. <a href="//puzzle.jamiehoward.co" target="_blank">See more →</a></p>
	</div>
	...
	<div class="mb-4">
		...
		<p class="mb-3">
			A notecard game-turned command line RPG. <a href="//github.com/jamiehoward/versus" target="_blank">See more →</a>
		</p>
